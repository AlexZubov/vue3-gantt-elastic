  ...
  computed: {
    ...
    height: {
      ...
      set(value) {
        ...
        this.$root.emitter.emit("row-height-change", Number(value));
      }
    },
    scope: {
      get() {
      ...
      set(value) {
        ...
        this.$root.emitter.emit("scope-change", Number(value));
      }
    },
    divider: {
      get() {
      ...
      set(value) {
        ...
        this.$root.emittet.emit("taskList-width-change", Number(value));
      }
    }
  }
};
